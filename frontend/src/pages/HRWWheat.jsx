...
// MAIN COMPONENT
// -----------------------------
export default function HRWWheat() {
  const commodity = "hrw-wheat";
  ...
  return (
    <div className="main-content">
      ...
      {/* FORECASTS MODE */}
      {dataSource === "Forecasts" && (
        <div className="card card-centered hrw-wheat-chart">
      ...
      {dataSource !== "Forecasts" && jsonPath && (
        <div className="card card-centered hrw-wheat-chart">
          ...
          >
            <ChartViewer jsonPath={jsonPath} variant="hrw-wheat" />
          </div>
        </div>
      )}
    </div>
